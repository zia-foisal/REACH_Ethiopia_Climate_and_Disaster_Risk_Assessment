...
def main():
    ...
    return_periods     = [10, 20, 50, 75, 100, 200, 500]  # example for Fathom FL [5, 10, 20, 50, 75, 100, 200, 250, 500, 1000]
									# example for Storm TC [10, 20, 50, 100, 200, 500] #CF [10,100,1000]
    ...
    class_edges        = [0.05, 0.25, 0.50, 1.00, 2.00] #[0.05, 0.25, 0.50, 1.00, 2.00] # FL [0.05, 0.25, 0.50, 1.00, 2.00] # TC [17.0, 32.0, 42.0, 49.0, 58.0, 70.0]
    save_check_raster  = True
